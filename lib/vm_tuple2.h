...
STD::string toString() const {
    ...
    bool operator==(const Tuple2T& t1) const {
        return equals(t1);
    }
    ...
    Tuple2 operator-(const Tuple2T& t1) const {
        return (Tuple2(*this)).operator-=(t1);
    }
...
TEMPLATE inline NAMESPACE::Tuple2T 
operator*(T s, const NAMESPACE::Tuple2T& t1) {
    return (NAMESPACE::Tuple2T(t1)).operator*=(s);
}

#ifdef USE_IO
TEMPLATE STD::ostream& 
operator<<(STD::ostream& o, const NAMESPACE::Tuple2T& t1) {
    return o << "(" << t1.x << "," << t1.y << ")";
}
#endif
...
#ifdef USE_TEMPLATE
typedef Tuple2<double> Tup2;
typedef Tuple2<float> Tup2f;
#else
typedef Tuple2 Tuple2d;
typedef Tuple2 Tuple2f;
#endif
